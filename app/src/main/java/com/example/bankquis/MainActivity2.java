...
public class MainActivity2 extends AppCompatActivity {
    ...
    String[] pertanyaan_kuis = new String[]{
              ...
              "3. Senjata tradisional khas aceh",
              "4. Benua biru adalah sebutan bagi benua",
    };

    //pilihan jawaban a, b, c, d
    String[] pilihan_jawaban = new String[]{
              "New York", "Washington DC", "Chicago", "Las Vegas",
              "Beruang", "Garuda", "Macan", "Elang",
              "Celurit", "Kapak Wiro Sableng", "Rencong", "Samurai",
              "Eropa", "Asia", "Afrika", "Amerika",
    };
